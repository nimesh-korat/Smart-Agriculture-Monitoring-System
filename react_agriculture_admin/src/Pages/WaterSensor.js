...
function WaterSensor() {
  ...
  useEffect(() => {
    ...
    try {
      axios.get('http://localhost:8000/api/admin/getWaterData').then((response) => {
                ...
                <div className="page-header float-right">
                  <div className="page-title">
                    <ol className="breadcrumb text-right">
                      ...
                      <li className="active">Water level table</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header">
                    <strong className="card-title">Water Level Table</strong>
                  </div>
